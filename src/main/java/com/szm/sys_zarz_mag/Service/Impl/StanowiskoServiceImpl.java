...
import com.szm.sys_zarz_mag.Repository.StanowiskoRepository;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import java.util.List;
@Service
public class StanowiskoServiceImpl {

    private StanowiskoRepository stanowiskoRepository;

    @Autowired
    public StanowiskoServiceImpl(StanowiskoRepository stanowiskoRepository) {
